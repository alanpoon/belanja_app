...
class Floorplan extends Component{
  ...
  constructor(props){
    ...
    this._pickImage = _pickImage.bind(this);
  ...
  getIpfs(){
     const __this= this;
     _pickImage(this.state.ipfs_add).then(function(value){
      if (value!="error"){
         __this.layers[0]["data"]=value.uri;
      var rerender = __this.state.rerender+1;
      console.log("update state",value.uri);
      __this.setState({rerender})
      }
     });
