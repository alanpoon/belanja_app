...
THREE.BallSpinerLoader.prototype = {
  makeCircle: function(config) {
    ...
    var circleRadius = config.radius || 5,
        ...
        circleGeometry = new THREE.SphereBufferGeometry( circleRadius, circleSegments,circleSegments ),
  ...
  initGroup: function() {
    ...
    for(var i=0;i<this.circleCount;i++) {
      ...
      var oneCircle = this.makeCircle({opacity:currOpacity, opacityStep: animationStep, radius: this.circleRadius,intersect: this.intersect});
